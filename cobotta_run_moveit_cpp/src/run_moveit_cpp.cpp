...
static const rclcpp::Logger LOGGER = rclcpp::get_logger("run_moveit_cpp");
...
int main(int argc, char** argv)
{
  ...
  static const std::string LOGNAME = "run_moveit_cpp";
  ...
  target_pose1.pose.position.x = 0.14;
  target_pose1.pose.position.y = -0.1;
  target_pose1.pose.position.z = 0.1;
  planning_components->setGoal(target_pose1, "link_J6_1"); // Move "link_J6_1" to "target_pose1"
  ...
  start_state.setFromIK(joint_model_group_ptr, start_pose); // currentState to start_pose IK

  // TODO
  planning_components->setGoal(start_state);
  auto plan_solution1_2 = planning_components->plan();
  ...
  planning_components->setGoal(target_pose1, "link_J6_1");
  ...
  target_pose2.pose.position.y = -0.05;
  target_pose2.pose.position.z = 0.35;
  planning_components->setGoal(target_pose2, "link_J6_1"); // Move "link_J6_1" to "target_pose1"
